...
export default function LandingPage() {
  ...
  const whatsappMessage = "היי! אני מעוניין/ת לשמוע עוד על ההזדמנות לעבודה מהבית עם GlobeHive";
  ...
  const testimonials = [
    {
      name: "רותם ש.",
      text: "תוך שבועיים כבר ראיתי תוצאות. ממליצה בחום!",
      rating: 5,
      earnings: "₪3,200",
    ...
    {
      name: "יואב ד.",
      text: "סוף סוף עבודה שאני יכול לעשות מהבית בלי בוס.",
      rating: 5,
      earnings: "₪5,400",
      timeframe: "החודש"
    },
    {
      name: "מיכל כ.",
      text: "לא האמנתי שזה יעבוד, אבל אחרי 3 שבועות כבר יש לי הכנסה קבועה!",
      rating: 5,
      earnings: "₪2,800",
      timeframe: "בחודש הראשון"
    },
    {
      name: "דני ר.",
      text: "ההכשרה הייתה מעולה והתמיכה מדהימה. הכי כיף לעבוד ככה!",
      rating: 5,
      earnings: "₪4,100",
      timeframe: "החודש"
    },
    {
      name: "שירה ל.",
      text: "עובדת 2-3 שעות ביום ומרוויחה יותר ממה שהרווחתי במשרה מלאה.",
      rating: 5,
      earnings: "₪6,500",
      timeframe: "החודש"
    },
    {
      name: "אורי מ.",
      text: "הקהילה כאן מדהימה, כולם עוזרים לכולם. ממליץ בחום!",
      rating: 5,
      earnings: "₪3,900",
      timeframe: "החודש"
    }
  ...
  // Pulsing elements
  const PulsingElement = ({ children, delay = 0 }) => (
    <motion.div
      animate={{
        scale: [1, 1.05, 1],
        opacity: [1, 0.8, 1],
